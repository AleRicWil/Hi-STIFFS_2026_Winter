...
class FilePage(QWidget):
    ...
    def browse_folder(self):
        ...
        folder_path = QFileDialog.getExistingDirectory(self.mainwindow, "Select Data Folder", 
                                                       self.current_base or self.mainwindow.settings.get('data_folder', RAW_DATA_BASE))
        if folder_path:
